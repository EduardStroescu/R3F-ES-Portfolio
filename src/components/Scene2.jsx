    ...
    <group ref={ref} scale-x={5} scale-y={2} scale-z={5}>
      {planeGroups.map((_, i) => (
        <line
          ...
          geometry={geometry}
          material={material}
          position={[i * 0.04 - planeGroups.length * -0.426, 0.5, 4.23]}
        />
      ))}
    </group>
  );
...
export default function Scene2({ active2, textRef, titleFont, renderTargetC }) {
  ...
  const getActiveProject = useCallback(
    ...
    [
      projectData.titles,
      projectData.titleColors,
      projectData.projectDescriptions,
        ...
        >
          ...
          >
            <div className="flex flex-row justify-center align-center pb-2 sm:pb-6">
              <button className="pointer-events-auto text-black bg-white border-white rounded-full mb-2 flex flex-row justify-center align-center my-[2px] ">
              ...
              <button className="pl-2 pointer-events-auto pb-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div className="flex text-white w-full h-full flex-row justify-around gap-x-[25%] sm:gap-x-[40%] md:gap-x-[25%]">
